...
function generateStepsBlog(){
  ...
  html += '</section>\n';
  html += '<style>.container{display:flex;flex-wrap:wrap;align-items:center}.image.banner.right{flex:1 1 50%;display:flex;justify-content:flex-end}.image.banner.left{flex:1 1 50%;display:flex;justify-content:flex-start}.image.banner img{max-width:100%;height:auto}.text{flex:1 1 50%;padding:20px 0 0 0}@media screen and (max-width:768px){.image.banner,.text{flex:1 1 100%}}.divider{border:none;height:2px;background:#e1e1e1!important;margin:30px 0}.toc-container{background:#f4f4f4;padding:20px;border:1px solid #ddd;border-radius:8px;margin:20px auto;max-width:100%}.toc{list-style:none;padding:0;margin:0}</style>';
